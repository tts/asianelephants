...
ui <- fluidPage(
  ...
  sidebarPanel(
    HTML("<div><span style='color:black'>
         ...
         <p></p>
         <p>Data presented in these maps consist mostly of observations (including one of my own) via <a href='https://gbif.org'>GBIF</a>, the Global Biodiversity Information Facility.
         ...
         <p></p>
         <p>Derived dataset GBIF.org (28 June 2021) Filtered export of GBIF occurrence data https://doi.org/10.15468/dd.vwcmpu</p>
         <p></p>
